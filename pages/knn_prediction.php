...
// Check authentication (both admin and user can access)
checkAuth();
    ...
    <div class="wrapper">
        ...
        <div id="content" class="content">
            ...
            <div class="container-fluid p-4">
                        ...
                        <div class="col-md-6">
                            <div class="input-summary">
                                ...
                                <div class="text-dark">
                                    ...
                                    <small><strong>Distance Metric:</strong> Euclidean Distance</small><br>
                ...
                <!-- K-Nearest Neighbors & Euclidean Distance - Full Width -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <small class="text-muted mb-3 d-block">
                                    ...
                                    Tetangga terdekat berdasarkan Euclidean Distance
                                </small>
                ...
                <!-- Euclidean Distance Calculation - Full Width -->
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-info text-white">
                                <h6 class="mb-0"><i class="fas fa-calculator me-2"></i>Detail Perhitungan Euclidean Distance</h6>
                            </div>
                            <div class="card-body">
                                <?php 
                                ...
                                <div class="formula-section mb-4 p-3 rounded-3" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-left: 4px solid #17a2b8;">
                                    <h6 class="text-info mb-2">
                                        <i class="fas fa-function me-2"></i>Euclidean Distance Formula
                                    </h6>
                ...
                <?php endif; ?>
                <?php endif; ?>
                <!-- End of prediction results section -->
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-lg-4"> -->
                        ...
                        <!-- <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <small class="text-muted">
                                    K-Nearest Neighbor mengklasifikasikan data berdasarkan jarak Euclidean ke K tetangga terdekat dalam training data.
                                </small>
                                <hr>
                                <div class="d-grid">
